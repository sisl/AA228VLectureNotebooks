...
# ╔═╡ 3cc40234-bb8b-401e-afee-148729935921
md"""
...
md"""
## Gaussian Mixture
$w_1 \mathcal N(\mu_1, \sigma_1^2) + (1-w_1)\mathcal N(\mu_2, σ_2^2)$
"""
...
md"""
Suppose we apply a function $f$ to $Z$ to get a new variable $X$:
"""
...
md"""
## What is the probability density of this new distribution?
...
md"""
### We just transformed a unimodal distribution into a multimodal one! 😎
...
- If you are interested in learning more about normalizing flows, I found [this tutorial](https://youtu.be/u3vVyFVU_lI?si=eIS2QXB2ItWAyr_z) to be quite helpful. (They are outside the score of this class.)
"""
...
md"""
μ1: $(@bind μ1 Slider(-4:0.1:4, show_value=true, default=0)) $nbsp $nbsp
μ2: $(@bind μ2 Slider(-4:0.1:4, show_value=true, default=0))

σ1: $(@bind σ1 Slider(0.5:0.05:1.5, show_value=true, default=1.0)) $nbsp $nbsp
σ2: $(@bind σ2 Slider(0.5:0.05:1.5, show_value=true, default=1.0))
...
manifest_format = "2.0"
project_hash = "53f20a9a394a9769b0a5577423e981cb8bad860e"
