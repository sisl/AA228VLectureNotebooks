...
# ╔═╡ 5efb75fd-c4b2-4e9f-bc87-edd40e499314
md"""
## Exact Linear Reachability
"""

# ╔═╡ f4a4c9fc-9764-4422-9432-2ca3d90ddd68
md"""
Time Step: $(@bind t Slider(1:21, default=1, show_value=true))

Maximum Noise Magnitude: $(@bind ϵ Slider(0.1:0.1:3, default=0.1, show_value=true))
"""

# ╔═╡ 4e2bca0a-e41e-444f-96cf-b135d4c02b14
begin
	sys_small = System(
	...
	function estimate_reachable_sets(sys, ψ)
		alg = SetPropagation(get_depth(sys))
		return reachable(alg, sys)
	end

	ℛ = estimate_reachable_sets(sys_small, ψ_small)

	τs = [rollout(sys_small, d=get_depth(sys_small)) for i in 1:100]

	md"> _Mass-Spring-Damper Reachability_"
end
...
# ╔═╡ 1413a43a-9050-42a7-b091-7d945492c574
plot(sys_small, ψ_small, ℛ, t=t, show_samples=true, τs=τs)
...
manifest_format = "2.0"
project_hash = "d8caccf5b698cf61dc6f0883e7949f0678dd2c91"
