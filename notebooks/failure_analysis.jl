...
# ╔═╡ 4d5a6a66-c29d-4cdc-aae5-57dff84434b9
md"""
## Falsification and Failure Distribution
"""
...
md"""
## Problem Parameters
Perception noise: $(@bind σ Slider(0.01:0.01:0.3, show_value=true, default=0.2))

Number of rollouts: $(@bind m Slider(1:1:150, show_value=true))
"""
...
begin
	...
	function Plots.plot(sys, ψ, τ=missing;
	...
	function plot_both(sys, ψ, τ=missing;
		...
		p1 = plot(sys, ψ, τ, is_dark_mode=dark_mode, title="Falsification", max_lines=max_lines, size=size)
		p2 = plot(sys, ψ, τ, is_dark_mode=dark_mode, title="Failure Distribution", max_lines=max_lines, size=size, plot_successes=false)
		return plot(p1, p2)
	end
